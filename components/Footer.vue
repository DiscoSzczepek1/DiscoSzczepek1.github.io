  ...
  <div class="container bg-black py-5 mt-5">
    <footer>
      <div class="mt-4 d-flex flex-wrap justify-content-between align-items-center">
        <div class="col-md-10 mb-0 text-muted">
          <p class="text-white">&copy; {{ new Date().getFullYear() + ' ' + $store.state.shop.name }}</p>
          <p>Serwer {{ $store.state.shop.name }} nie jest w żaden sposób powiązany z firmą Mojang Studios oraz Microsoft Studios.</p>
          <!-- usunięcie, użycie znacznika rel w linku, zmiana/zmniejszenie widoczności poniższego akapitu będzie złamaniem licencji oraz blokadą sklepu -->
          <!-- jedyna dozwolona zmiana to kolorystyka, jednakże poniższa linijka musi nadal pozostać dobrze widoczna -->
          <!-- zakazana jest również edycja zawartości poniższej linijki, nie można nic dopisywać, podawać się za autora, ani zmieniać -->
          <p>Strona jest zasilana przez <a href="https://vishop.pl" class="text-muted">itemshop Minecraft</a> <b>VIshop.pl</b></p>
        </div>

        <ul class="nav col-md-2 justify-content-end">
          <!-- najlepiej używać ikon svg -->
          <li class="nav-item">
            <a href="#" class="px-2 text-muted link-icon">
